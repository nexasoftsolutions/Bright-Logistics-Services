    ...
    >
      <body className="min-h-full flex flex-col bg-background font-body-md text-on-background overflow-x-hidden">
        ...
        <div className="fixed right-8 flex flex-col z-50 gap-6 bottom-[120px]">
          ...
          <a href="https://wa.me/923000641482" className="w-14 h-14 bg-whatsapp text-white rounded-full flex items-center justify-center shadow-lg hover:opacity-90 transition-all hover:scale-110 group" aria-label="WhatsApp Us">
