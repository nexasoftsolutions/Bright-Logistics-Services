    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative bg-primary text-on-primary py-12 lg:py-32 overflow-hidden flex items-center justify-center min-h-[409px]">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-margin-mobile lg:px-margin-desktop w-full text-center space-y-6 mt-20">
          <span className="text-label-bold text-secondary-container bg-secondary-container/20 px-4 py-1 rounded-full uppercase tracking-widest text-xs">
            Nationwide Coverage
          </span>
          <h1 className="text-headline-xl text-on-primary text-center">
        ...
        <SectionContainer className="space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 relative">
              <div 
                className="absolute -top-12 -left-8 text-9xl text-primary-fixed-dim/20 z-0 pointer-events-none font-bold" 
                style={{ writingMode: 'vertical-rl' }}
              >
                ROUTES
              </div>
              <div className="relative z-10 space-y-6">
                <h2 className="text-headline-lg text-primary">Extensive Route Network</h2>
                ...
                <div className="bg-surface-container rounded-2xl p-6 shadow-sm border border-outline-variant/30 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-headline-sm text-primary mb-2">Real-Time Optimization</h4>
      ...
      <section className="py-12 md:py-24 bg-surface-container text-on-surface relative overflow-hidden">
        ...
        <SectionContainer className="relative z-10">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-headline-lg text-primary">Major Hubs &amp; Destinations</h2>
              ...
              return (
                <div key={hub.id} className="bg-surface rounded-xl p-6 shadow-sm border border-outline-variant/30 hover:border-primary hover:shadow-md transition-all duration-300 group">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-headline-sm text-primary">{hub.name}</h3>
                  </div>
                  <p className="text-body-sm text-on-surface-variant">{hub.description}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="mt-12 bg-primary text-on-primary rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h4 className="text-headline-md mb-2">And Beyond...</h4>
            ...
            <a className="relative z-10 shrink-0 bg-secondary-container text-on-secondary-fixed-variant px-8 py-3 rounded-full text-label-bold hover:bg-secondary hover:text-white transition-colors" href="/quote">
      ...
      <CTABanner 
        headline="Ship Anywhere in Pakistan" 
        description="Leverage our extensive network for seamless nationwide logistics." 
